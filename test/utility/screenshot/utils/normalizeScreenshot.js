const CropDimension = require('./CropDimension.js');
const getBase64ImageSize = require('./getBase64ImageSize.js');
const { cropImage, scaleImage } = require('./image/index.js');
...
module.exports = async function normalizeSreenshot(browser, screenDimensions, base64Screenshot) {
